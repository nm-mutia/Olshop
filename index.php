...
<body>
	<div class="jumbotron text-center" style="margin-bottom:0" id="jumjum">
		<h1>Rona Clothing</h1>
	  	<p>Women, Men, and Kids Styling</p> 
	</div>
	<div id="navi">
		...
		<div class="row">
		    <div class="col-sm-8" style="background-color: orange;">
		    	<br>
		      	...
		      	<h2>PRIA</h2>
		      	<h5>Perlengkapan Pria, Updated</h5>
		      	...
		      	<h2>ANAK - ANAK</h2>
		      	<h5>Perlengkapan Anak, Updated</h5>
		      	<div class="fakeimg">Fake Image</div>
		      	<p>Some text..</p>
		      	<div class="row">
